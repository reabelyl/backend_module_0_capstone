...
if cups_of_flour == 1 && has_sauce == true
  p "I cannot make pizza! OH no! WRONG! Need more flower"

elsif cups_of_flour == 5 && has_sauce == false
  p "I cannot make pizza! OH no! Sad days. Maybe next time... PIZZA NEEDS SAUCE!!"

elsif cups_of_flour == 2 && has_sauce == true
  p "WATCH OUT! I can make pizza!"

elsif cups_of_flour == 3 && has_sauce == true
  p "I can make pizza! OH no! WATCH OUT!"
end
